namespace Masa.Blazor.Pro.Rcl.Data.App.User
{
        ...
        static List<UserDto> _datas = new()
    {
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/4.svg",
            Role = "Editor",
            Plan = "Company",
            Status = "Active",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/2.svg",
            Role = "Admin",
            Plan = "Basic",
            Status = "Active",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/3.svg",
            Role = "Maintainer",
            Plan = "Basic",
            Status = "Pending",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/7.svg",
            Role = "Maintainer",
            Plan = "BAsic",
            Status = "Pending",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/8.svg",
            Role = "Maintainer",
            Plan = "Basic",
            Status = "Inactive",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/9.svg",
            Role = "Admin",
            Plan = "Basic",
            Status = "Inactive",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/10.svg",
            Role = "Editor",
            Plan = "Basic",
            Status = "Active",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            FullName = "Beverlie Krabbe",
            Email = "bkrabbe1d@home.pl",
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/11.svg",
            Role = "Editor",
            Plan = "Company",
            Status = "Active",
            Contact = "(397) 294-5153",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            FullName = "Beverlie Krabbe",
            Email = "bkrabbe1d@home.pl",
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/12.svg",
            Role = "Editor",
            Plan = "Company",
            Status = "Active",
            Contact = "(397) 294-5153",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            FullName = "Beverlie Krabbe",
            Email = "bkrabbe1d@home.pl",
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/13.svg",
            Role = "Editor",
            Plan = "Company",
            Status = "Active",
            Contact = "(397) 294-5153",
        ...
        new UserDto("Pending", "Subscriber", DateOnly.FromDateTime(DateTime.Now), "(895) 401-4255", "Male", GetPermissionsList())
        {
            ...
            FullName = "Beverlie Krabbe",
            Email = "bkrabbe1d@home.pl",
            HeadImg = "_content/Masa.Blazor.Pro.Rcl/img/avatar/14.svg",
            Role = "Editor",
            Plan = "Company",
            Status = "Active",
            Contact = "(397) 294-5153",
